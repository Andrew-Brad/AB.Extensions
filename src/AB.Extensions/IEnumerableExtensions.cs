...
public static class IEnumerableExtensions
{
    ...
    public static IOrderedEnumerable<T> OrderBy<T, TKey>(this IEnumerable<T> source, Func<T, TKey> keySelector, OrderByDirection direction) => OrderBy(source, keySelector, null, direction);
    ...
    public static IOrderedEnumerable<T> ThenBy<T, TKey>(this IOrderedEnumerable<T> source, Func<T, TKey> keySelector, OrderByDirection direction) => ThenBy(source, keySelector, null, direction);
    ...
    /// <param name="rng">
    /// The random source to draw from. When <c>null</c> (the default) a thread-safe shared instance is used;
